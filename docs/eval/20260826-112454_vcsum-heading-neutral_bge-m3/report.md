# 离线检索评测报告：vcsum-heading-neutral

## 指纹（复现所需全部信息）

| 字段 | 值 |
|---|---|
| 生成时间 | 2026-08-26T11:24:54+08:00 |
| 数据集 | vcsum-heading-neutral（seed=20260826, manifest=66637efb419e…） |
...
| 命中阈值 | 0.60（敏感性见各组合明细） |
| 琅嬛仓库 | eb039a4295ac |
| 被测实例 | standalone（http://127.0.0.1:53152） |
...
|---|---|---|---|---|---|
| vector_only | 0.8201 | 0.8993 | 0.7101 | 0.7551 | OK |
| fts_only | 0.2014 | 0.2014 | 0.1978 | 0.1988 | OK |
| hybrid | 0.8561 | 0.9065 | 0.7346 | 0.7761 | OK |
| hybrid_rerank | 0.9137 | 0.9353 | 0.8718 | 0.8870 | OK |

阈值敏感性（ndcg@10）:

| 通道组合 | @0.50 | @0.60 | @0.80 |
|---|---|---|---|
| vector_only | 0.7790 | 0.7551 | 0.7156 |
| fts_only | 0.2060 | 0.1988 | 0.1916 |
| hybrid | 0.7996 | 0.7761 | 0.7365 |
| hybrid_rerank | 0.9105 | 0.8870 | 0.8465 |
