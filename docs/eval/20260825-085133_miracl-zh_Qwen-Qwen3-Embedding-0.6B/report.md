...
| 字段 | 值 |
|---|---|
| 生成时间 | 2026-08-25T08:51:33+08:00 |
...
| Embedding | siliconflow/Qwen/Qwen3-Embedding-0.6B dim=1024 |
| Rerank | 未启用 |
| 通道矩阵 | top_k=50 final_top_k=10 |
| 命中阈值 | 0.60（敏感性见各组合明细） |
| 琅嬛仓库 | 63c8c0cf1ac7 |
| 被测实例 | standalone（http://127.0.0.1:65019） |
...
|---|---|---|---|---|---|
| vector_only | 0.9463 | 0.9759 | 0.9858 | 0.9661 | OK |
| fts_only | 0.0000 | 0.0000 | 0.0000 | 0.0000 | OK |
| hybrid | 0.9463 | 0.9759 | 0.9858 | 0.9661 | OK |
...
| 通道组合 | @0.50 | @0.60 | @0.80 |
|---|---|---|---|
| vector_only | 0.9654 | 0.9661 | 0.9712 |
| fts_only | 0.0000 | 0.0000 | 0.0000 |
| hybrid | 0.9654 | 0.9661 | 0.9712 |
...
| 通道组合 | recall@5 | recall@10 | mrr@10 | ndcg@10 | 状态 |
|---|---|---|---|---|---|
| vector_only | 0.7415 | 0.7817 | 0.9202 | 0.7799 | OK |
| fts_only | 0.0000 | 0.0000 | 0.0000 | 0.0000 | OK |
| hybrid | 0.7415 | 0.7817 | 0.9202 | 0.7799 | OK |
| hybrid_rerank | - | - | - | - | N/A（未配置 rerank 模型） |
...
| 通道组合 | @0.50 | @0.60 | @0.80 |
|---|---|---|---|
| vector_only | 0.7760 | 0.7799 | 0.7910 |
| fts_only | 0.0000 | 0.0000 | 0.0000 |
| hybrid | 0.7760 | 0.7799 | 0.7910 |
