...
func TestToolInputSchemasMatchStructDeclarations(t *testing.T) {
	...
	t.Run("knowledge_base_create", func(t *testing.T) {
		...
		assertPropertyType(t, schema, "strategy", "string")
		assertPropertyType(t, schema, "enable_parent_child", "boolean")
		assertPropertyType(t, schema, "parent_chunk_size", "integer")
		assertPropertyType(t, schema, "child_chunk_size", "integer")
