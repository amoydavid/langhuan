...
func documentRevisionToRow(revision *model.DocumentRevision) (*DocumentRevisionRow, error) {
	...
	return &DocumentRevisionRow{
		...
		ParseManifest: manifest, ParserRawMarkdownKey: nullableString(revision.ParserRawMarkdownKey),
		ProcessingVersion: revision.ProcessingVersion, Status: string(revision.Status),
