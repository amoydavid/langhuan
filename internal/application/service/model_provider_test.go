...
func TestModelProviderServicePreservesOrReplacesCredentialsExplicitly(t *testing.T) {
	...
	service := NewModelProviderService(repository, fakeCredentialCipher{}, fakeFactoryRegistry{factory: factory})
...
func TestModelProviderServiceEnforcesScopeAndDeleteReference(t *testing.T) {
	...
	workspaceID, actorID := uuid.New(), uuid.New()
	repository := newFakeModelProviderRepository()
	service := NewModelProviderService(repository, fakeCredentialCipher{}, fakeFactoryRegistry{factory: &fakeEmbeddingFactory{}})
	...
	service = NewModelProviderService(repositoryWithModels, fakeCredentialCipher{}, fakeFactoryRegistry{factory: &fakeEmbeddingFactory{}})
